...
function showLogin(err){
  app.innerHTML=`<div class="login"><div class="login-box"><h1>红薯医生 Admin</h1><p>管理员面板</p>
...
function showDash(d){
  ...
  <h1>红薯医生 Admin</h1><div class="sub">${d.timestamp} · uptime ${Math.round(d.uptime_seconds/60)}min</div>
  <div class="g">
